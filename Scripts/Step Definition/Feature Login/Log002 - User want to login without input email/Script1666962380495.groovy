...
WebUI.callTestCase(findTestCase('Page/Login/Click Enter to Login Page'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Page/Login/Verify Account'), [:], FailureHandling.STOP_ON_FAILURE)
